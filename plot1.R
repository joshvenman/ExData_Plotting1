# plot1.R, Produce Plot1 for Course Project 1 - Exploratory Data Analysis
...
# Create Histogram for Plot 1 with required parameters
par(mar=c(5,5,4,4),cex.axis=0.75,cex.lab=0.75,cex.main=1,font.lab=2)
hist(d$Global_active_power, main="Global Active Power",xlab="Global Active Power (kilowatts)",ylab="Frequency", col="#FF0000")
