# plot4.R, Produce Plot4 for Course Project 1 - Exploratory Data Analysis
...
# This output has four individual plots - use mfrow to define grid for plots
par(mar=c(5,5,4,4),cex.axis=1,cex.lab=1,cex.main=1,font.lab=2, mfrow=c(2,2))

# Plot 1 - Top Left
plot(d$plottime,d$Global_active_power,type="s",xlab="",ylab="Global Active Power")

# Plot 2 - Top Right
plot(d$plottime,d$Voltage,type="s",xlab="datetime",ylab="Voltage")
...
legend("topright",c("Sub_metering_1","Sub_metering_2","Sub_metering_3"),lty=c(1,1,1),col=c("black","blue","red"),bty="n",cex=0.8)

# Plot 4 - Bottom Right
plot(d$plottime,d$Global_reactive_power,type="s",xlab="datetime",ylab="Global_reactive_power")
